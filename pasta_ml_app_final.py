...
# ═══════════════════════════════════════════════════════════════════════════
# TAB: CLAUDE AI — Results Analysis & Paper Assistant
# ═══════════════════════════════════════════════════════════════════════════
...
with tab_claude:
    ...
    if not _ANTHROPIC_AVAILABLE:
        ...
        # ── Screenshot guide ───────────────────────────────────────────────────
        with st.expander("📖 Which screenshot to take for each mode", expanded=False):
            st.markdown("""
| Mode | Go to this tab | What to capture |
|---|---|---|
| 📊 Full Model Comparison | Step 5 · ML Models | Full regression metrics table |
| 🔍 SHAP Attribution | Step 5 · ML Models | SHAP bar chart (scroll down) |
| 🌐 Live Data Validation | Real Data + CTI | Live bundle summary panel |
| 📈 Scalability Analysis | Step 6 · Scalability | Log-log chart + runtime table |
| 🧪 Permutation Test | Step 5 · ML Models | Permutation test histogram |
| 📸 Figure Quality | Any tab | Whatever figure you want reviewed |

**Chrome tip:** `F12` → `Ctrl+Shift+P` → type `screenshot` → **Capture full size screenshot**  
**Firefox tip:** `F12` → `⋮` → **Take a Screenshot** → **Save Full Page**
            """)
