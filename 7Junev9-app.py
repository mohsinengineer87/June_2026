...
with st.sidebar:
    ...
    n_assets = st.number_input(
        "Total Assets", min_value=20, max_value=2000, value=150, step=10,
    ...
    mix_raw = {}
    _mix_defaults = [25, 15, 15, 10, 15, 10, 10]
    ...
    n_scenarios = st.number_input(
        "Scenarios to generate", min_value=200, max_value=10000, value=1000, step=100,
